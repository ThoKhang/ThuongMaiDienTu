...
export const adminService = {
    ...
    updatePartnerConfig: async (id, tyLeHoaHong, trangThai) => {
        const response = await api.put(`/api/admin/partners/${id}/config?tyLeHoaHong=${tyLeHoaHong}&trangThai=${trangThai}`);
        return response.data;
    }
};