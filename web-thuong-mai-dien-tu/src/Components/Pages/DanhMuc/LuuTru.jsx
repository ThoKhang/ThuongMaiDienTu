        ...
        <UserLayout>
            <div className="px-4 md:px-8 py-6 w-full">
                ...
                <div className="mb-4 text-sm text-gray-500">
                    {boLocGia && (
                        <span> · Đang lọc: <span className="text-orange-500 font-semibold">
                ...
                {!loading && danhSachHienThi().length > 0 && (
                    <p className="text-center text-sm text-gray-400 mt-3">
                        Trang {trangHienTai + 1} / {data?.tongSoTrang || 1} — Tổng {data?.tongSoSanPham || 0} sản phẩm
                    </p>
                )}
